    ...
    def run(self):
        ...
        try:
            ...
            if device.type == 'cuda':
                ...
                print('[Learner] CUDA %s capability %d.%d, TF32 enabled.' %
                      (props.name, props.major, props.minor), flush=True)
