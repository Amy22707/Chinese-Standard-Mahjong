class MahjongGBAgent:
    # Compatibility with RL/env.py.  The lightweight environment only exposes
    # these attributes to match the multi-agent API; it does not inspect them
    # while running Mahjong games.
