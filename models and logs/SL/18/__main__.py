...
USE_RISK_HEAD = os.environ.get('USE_RISK_HEAD', '1') == '1'
POSTPROCESS_MODE = os.environ.get('POSTPROCESS_MODE', 'light')
TENPAI_LEARNED_WEIGHT = min(1.0, max(0.0, float(os.environ.get('TENPAI_LEARNED_WEIGHT', '1.0'))))
NORMALIZE_DISCARD_LOGITS = os.environ.get('NORMALIZE_DISCARD_LOGITS', '0') == '1'
FAN_WAIT_WEIGHT = max(0.0, float(os.environ.get('FAN_WAIT_WEIGHT', '0.12')))
MAX_SEQ_LEN = 80
...
if __name__ == '__main__':
    model = CNNModel()
    data_dir = os.environ.get('MODEL_PATH', '/data/best17.pkl')
